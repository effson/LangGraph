...
def main():
    # 数据存储到D:\\sqlitedb目录下面，需要目录存在
    conn = sqlite3.connect(database="D:\\sqlitedb\\sqlite_data.db", check_same_thread=False)
...
"""
Initial state: 
StateSnapshot(values={}, next=(), config={'configurable': {'thread_id': 'user-001'}}, 
...
Final state: 
StateSnapshot(values={'messages': ['abc', 'def']}, next=(), 
config={'configurable': {'thread_id': 'user-001', 'checkpoint_ns': '', 'checkpoint_id': '1f13be70-7d1e-6656-8001-b75cab064470'}}, 
metadata={'source': 'loop', 'step': 1, 'parents': {}}, created_at='2026-04-19T11:58:07.987669+00:00', 
parent_config={'configurable': {'thread_id': 'user-001', 'checkpoint_ns': '', 'checkpoint_id': '1f13be70-7d1c-609c-8000-8d69219fd82a'}}, 
tasks=(), interrupts=())
