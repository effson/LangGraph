...
def step_one(state: PersistenceState) -> dict:
    print("步骤 1")
    return {
        "messages": ["步骤 1 完成"],
        "step_count": 1
...
def step_two(state: PersistenceState) -> dict:
    print("步骤 2")
    return {
        "messages": ["步骤 2 完成"],
        "step_count": 1
...
def step_three(state: PersistenceState) -> dict:
    print("步骤 3")
    return {
        "messages": ["步骤 3 完成"],
        "step_count": 1
...
步骤 2
步骤 3
执行结果result: {'messages': ['开始执行', '步骤 1 完成', '步骤 2 完成', '步骤 3 完成'], 'step_count': 3}

2. 检查存储状态:
保存的状态: {'messages': ['开始执行', '步骤 1 完成', '步骤 2 完成', '步骤 3 完成'], 'step_count': 3}
下一个节点: ()

==================================================
当前状态: {'messages': ['开始执行', '步骤 1 完成', '步骤 2 完成', '步骤 3 完成'], 'step_count': 3}
==================================================
当前状态: {'messages': ['开始执行', '步骤 1 完成', '步骤 2 完成'], 'step_count': 2}
==================================================
当前状态: {'messages': ['开始执行', '步骤 1 完成'], 'step_count': 1}
==================================================
...
================================================================================
3. 恢复执行:
恢复执行结果: {'messages': ['开始执行', '步骤 1 完成', '步骤 2 完成', '步骤 3 完成'], 'step_count': 3}
