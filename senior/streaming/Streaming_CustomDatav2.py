'''
从LangGraph节点或工具内部发送自定义用户定义数据，遵循以下步骤：
...
def main():
    ...
    print("--- 2. updates streaming only ---")
    for chunk in graph.stream(inputs, stream_mode="updates"):
        print(f"状态更新: {chunk}")

    print("\n" + "=" * 50 + "\n")
    #
    print("--- 3. custom + updates ---")
    try:
