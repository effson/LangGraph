...
def main():
    ...
    print(f"1. 角色: {story1['character']}    2. 背景: {story1['setting']}    3. 剧情: {story1['plot']}    4. 结局: {story1['ending']}")
    print()
    ...
    print(f"1. 新角色: {story2['character']}    2. 背景: {story2['setting']}    3. 剧情: {story2['plot']}    4. 结局: {story2['ending']}")
    print()
...
1. 角色: 一只会说话的猫    2. 背景: 在一个神秘的图书馆里    3. 剧情: 一只会说话的猫在在一个神秘的图书馆里发现了一本会发光的书    4. 结局: 当一只会说话的猫在在一个神秘的图书馆里发现了一本会发光的书时，整个图书馆都被魔法光芒照亮了

2. 查看第一个故事的历史状态...
历史状态:
  0. 下一步节点: ()
     检查点ID: 1f13bf4d-8d3d-66d1-8004-c211ba65fd5a
  ...
  1. 下一步节点: ('write_ending',)
     检查点ID: 1f13bf4d-8d3d-66d0-8003-d337f84a6349
     状态值: {'character': '一只会说话的猫', 'setting': '在一个神秘的图书馆里', 'plot': '一只会说话的猫在在一个神秘的图书馆里发现了一本会发光的书'}

  2. 下一步节点: ('develop_plot',)
     检查点ID: 1f13bf4d-8d3d-66cf-8002-f75930bd9582
     状态值: {'character': '一只会说话的猫', 'setting': '在一个神秘的图书馆里'}

  3. 下一步节点: ('set_setting',)
     检查点ID: 1f13bf4d-8d3a-6f7d-8001-cc66e1ff1361
     状态值: {'character': '一只会说话的猫'}

  4. 下一步节点: ('create_character',)
     检查点ID: 1f13bf4d-8d3a-6f7c-8000-106a156eac40

  5. 下一步节点: ('__start__',)
     检查点ID: 1f13bf4d-8d38-6745-bfff-ede42d978a5a

3. 从中间状态恢复执行，创建第二个故事...
选中的状态: ('develop_plot',)
选中的状态值: {'character': '一只会说话的猫', 'setting': '在一个神秘的图书馆里'}
新配置: {'configurable': {'thread_id': '42548db5-5fe8-458d-b23d-d44923a8c890', 'checkpoint_ns': '', 'checkpoint_id': '1f13bf4d-8d42-6501-8003-9cc359a10716'}}
...
1. 新角色: 一只会飞的龙    2. 背景: 在一个神秘的图书馆里    3. 剧情: 一只会飞的龙在在一个神秘的图书馆里发现了一本会发光的书    4. 结局: 当一只会飞的龙在在一个神秘的图书馆里发现了一本会发光的书时，整个图书馆都被魔法光芒照亮了
