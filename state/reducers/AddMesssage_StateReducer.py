...
{'messages': 
  [
    HumanMessage(content='Hi there!', additional_kwargs={}, response_metadata={}, id='d32578f7-f83d-4434-88f8-ce22c436d4dd'), 
    AIMessage(content='Hello from node 1', additional_kwargs={}, response_metadata={}, id='4261c2cd-b3c6-424a-b579-7d6b03c5692c', tool_calls=[], invalid_tool_calls=[]), 
    AIMessage(content='Hello from node 2', additional_kwargs={}, response_metadata={}, id='5e82a156-6128-4a76-9ae6-803a9d85f4c8', tool_calls=[], invalid_tool_calls=[])
  ]
}
