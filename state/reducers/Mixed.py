...
"""
{
  'messages': 
    [
      HumanMessage(content='Hello, how are you?', additional_kwargs={}, response_metadata={}, id='8e581113-33ba-4352-bb10-eae73c0aa9e3'), 
      AIMessage(content='Echo: Hello, how are you?', additional_kwargs={}, response_metadata={}, id='f73ac1da-0ae6-47fd-9fd4-534580a23e63', tool_calls=[], invalid_tool_calls=[])
    ], 
